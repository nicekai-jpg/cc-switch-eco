...
describe("SettingsPage integration", () => {
  it("loads default settings from MSW", async () => {
    ...
    expect((appInput as HTMLInputElement).value).toBe("/home/mock/.cc-switch-eco");
  });
  ...
  it("allows browsing and resetting directories", async () => {
    ...
    expect(appInput.value).toBe("/home/mock/.cc-switch-eco");

    fireEvent.click(browseButtons[0]);
    await waitFor(() =>
      expect(appInput.value).toBe("/home/mock/.cc-switch-eco/picked"),
    );

    fireEvent.click(resetButtons[0]);
    await waitFor(() => expect(appInput.value).toBe("/home/mock/.cc-switch-eco"));
