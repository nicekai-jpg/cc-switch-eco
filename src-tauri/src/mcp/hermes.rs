...
//!
//! Handles conversion between CC Switch Eco unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | CC Switch Eco unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// CC Switch Eco has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: CC Switch Eco -> Hermes
// ============================================================================

/// Convert CC Switch Eco unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> CC Switch Eco
// ============================================================================

/// Convert Hermes format to CC Switch Eco unified format
///
/// Conversion rules:
...
/// `existing` — this prevents CC Switch Eco from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive CC Switch Eco round-trip"
        );
    }
