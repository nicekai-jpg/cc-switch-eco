...
//!
//! 本模块处理 CC Switch Eco 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | CC Switch Eco 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: CC Switch Eco → OpenCode
// ============================================================================

/// Convert CC Switch Eco unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → CC Switch Eco
// ============================================================================

/// Convert OpenCode format to CC Switch Eco unified format
///
/// Conversion rules:
