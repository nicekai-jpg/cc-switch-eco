...
import { AppWindow, MonitorUp, Power, EyeOff, Shield } from "lucide-react";
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <ToggleRow
          ...
          title={t("settings.claudeBypassPermissions")}
          description={t("settings.claudeBypassPermissionsDescription")}
          checked={!!settings.claudeBypassPermissions}
          onCheckedChange={(value) =>
            onChange({ claudeBypassPermissions: value })
          }
        />
