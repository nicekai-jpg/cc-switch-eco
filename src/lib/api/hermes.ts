...
/**
 * Hermes Agent configuration API (CC Switch Eco side).
 *
 * CC Switch Eco intentionally keeps its Hermes surface minimal — deep configuration
 * (model, agent behavior, env vars, skills, cron, logs, analytics) lives in
 * the Hermes Web UI at http://127.0.0.1:9119. CC Switch Eco only reads the `model`
